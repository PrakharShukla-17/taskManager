    ...
    <div className="min-h-screen flex dark:bg-navy-950">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-navy-900 flex-col items-center justify-center p-12 relative overflow-hidden">
        ...
        <div className="relative z-10 text-center max-w-sm">
          ...
          <h1 className="text-3xl font-bold text-white mb-3">TaskManager</h1>
          <p className="text-navy-300 text-base leading-relaxed">Organize your work, track your progress, and stay on top of everything that matters.</p>
          <div className="mt-8 space-y-3 text-left">
            {['Create and manage tasks with ease','Prioritize with low, medium, high flags','Filter by status — pending or completed','Search across all your tasks instantly'].map(f => (
      ...
      <div className="flex-1 flex items-center justify-center p-6 bg-slate-50 dark:bg-navy-950">
        <div className="w-full max-w-sm">
          ...
          <h2 className="text-2xl font-bold text-navy-900 dark:text-slate-100 mb-1">Welcome back</h2>
          <p className="text-sm text-navy-500 dark:text-navy-400 mb-7">Sign in to your account to continue</p>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <div className="relative">
                <input type={showPw ? 'text' : 'password'} autoComplete="current-password" className={`input-field pr-11 ${errors.password ? 'border-red-400 focus:ring-red-400' : ''}`} placeholder="Your password" value={form.password} onChange={e => setForm({ ...form, password: e.target.value })} />
          ...
          <p className="mt-6 text-center text-sm text-navy-500 dark:text-navy-400">
            ...
            <Link to="/register" className="font-semibold text-accent-600 dark:text-accent-400 hover:underline">Sign up</Link>
          </p>
        </div>
      </div>
    </div>
